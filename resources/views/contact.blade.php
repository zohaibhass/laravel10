@extends('layouts.app')
@section('title', ' contact Peaks Platters')
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h5 class="section-title ff-secondary text-center text-primary fw-normal">Contact Peaks Platters</h5>
                ...
                <div class="col-12">
                    <div class="row gy-4">
                        <div class="col-md-4">
                            ...
                            <p><i class="bi bi-whatsapp"></i>03495767873</p>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <p><i class="bi bi-telephone-forward"></i>0355555555</p>
                        </div>
                    </div>
                </div>
